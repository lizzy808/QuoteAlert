...
#define COCOAPODS_POD_AVAILABLE_MSPageViewController
#define COCOAPODS_VERSION_MAJOR_MSPageViewController 1
#define COCOAPODS_VERSION_MINOR_MSPageViewController 0
#define COCOAPODS_VERSION_PATCH_MSPageViewController 1
